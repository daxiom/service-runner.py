...
PROJECT_NAME:=service_runner
DOCKER_NAME:=service-runner
...
build-req: clean ## Upgrade requirements
	...
	pip install -Ur requirements/package.txt ;\
	pip freeze | sort > requirements.txt ;\
	cat requirements/non-pypi.txt >> requirements.txt ;\
	pip install -Ur requirements/non-pypi.txt
